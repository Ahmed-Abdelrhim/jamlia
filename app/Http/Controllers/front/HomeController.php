...
class HomeController extends Controller
{
    ...
    public function Home(Request $request)
    {
        ...
        $data =  Division::query()->where('id', '1')->with('Categories')->latest()->first();
        $catss = Category::query()->with('Division')->pluck('id')->toArray();
        ...
        $slids =  Pannar::query()->where('type', '1')->inRandomOrder()->get();

        // $pans =   Pannar::query()->where('type', '1')->inRandomOrder()->first();
        $pans =   Pannar::query()->where('type', '2')->inRandomOrder()->first();


        // $pannns = Pannar::query()->where('type', '1')->inRandomOrder()->take(2)->get();
        $pannns = Pannar::query()->where('type', '3')->inRandomOrder()->take(1)->get();
