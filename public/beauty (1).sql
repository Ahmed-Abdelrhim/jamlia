...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 27, 2023 at 03:35 PM
...
CREATE TABLE `pannars` (
  ...
  `kind` enum('1','2') NOT NULL DEFAULT '1',
...
(1, 'ميبلين', 'maybelline', '<p>ميبلين</p>', '<p>maybelline</p>', '27-08-2316931432261692619399.jpg', '1', '1', '[\"2\"]', 1.00, 5000.00, '2023-08-27 11:33:46', '2023-08-27 11:33:46');
