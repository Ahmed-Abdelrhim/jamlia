...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 28, 2023 at 03:59 PM
...
CREATE TABLE `configurations` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `smtp_type` varchar(191) DEFAULT NULL,
  `smtp_username` varchar(191) DEFAULT NULL,
  `smtp_password` varchar(191) DEFAULT NULL,
  `smtp_sender_email` varchar(191) DEFAULT NULL,
  `smtp_sender_name` varchar(191) DEFAULT NULL,
  `smtp_port` int(11) DEFAULT NULL,
  `smtp_host` varchar(191) DEFAULT NULL,
  `smtp_encryption` varchar(191) DEFAULT NULL,
  `sms_number` varchar(191) DEFAULT NULL,
  `sms_password` varchar(191) DEFAULT NULL,
  `sms_sender_name` varchar(191) DEFAULT NULL,
  `oneSignal_application_id` varchar(191) DEFAULT NULL,
  `oneSignal_authorization` varchar(191) DEFAULT NULL,
  `fcm_server_key` varchar(191) DEFAULT NULL,
  `fcm_sender_id` varchar(191) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `customers` (
  ...
  `active_phone` varchar(191) DEFAULT NULL,
...
CREATE TABLE `dealers` (
  ...
  `avatar` varchar(191) NOT NULL DEFAULT 'default.png',
  `active` enum('0','1') NOT NULL DEFAULT '1',
  `commercial_registration_num` varchar(191) DEFAULT NULL,
  `tax_card_num` varchar(191) DEFAULT NULL,
  `code` int(11) DEFAULT NULL,
  `active_phone` varchar(191) DEFAULT NULL,
  `api_token` varchar(80) DEFAULT NULL,
  `ip` varchar(191) DEFAULT NULL,
...
CREATE TABLE `orders` (
  ...
  `product_id` bigint(20) UNSIGNED DEFAULT NULL,
  `customer_type` enum('c','d') NOT NULL,
  `status` enum('1','2','3','4') NOT NULL DEFAULT '1',
  `pay_type` enum('1','2') DEFAULT NULL,
  `pay_status` enum('1','2') DEFAULT NULL,
  `ip` varchar(191) DEFAULT NULL,
...
(1, 'ميبلين', 'maybelline', '<p>ميبلين</p>', '<p>maybelline</p>', '27-08-2316931432261692619399.jpg', '1', '1', '[\"2\"]', 1.00, 5000.00, '2023-08-27 11:33:46', '2023-08-27 11:52:05'),
(2, 'welcome hair', 'welcome hair', '<p>welcome hair beautigul again</p>', '<p>welcome hair beautigul again</p>', '28-08-2316932132781957858854.jpg', '1', '1', '[\"2\"]', 1.00, 5000.00, '2023-08-28 07:01:18', '2023-08-28 07:01:18'),
(3, 'Word View', 'Word View', '<p>Word View</p>', '<p>Word View</p>', '28-08-231693216723538521982.jpg', '2', '1', '[\"2\"]', 1.00, 5000.00, '2023-08-28 07:58:44', '2023-08-28 07:58:44'),
(4, 'Test Image', 'Test Image', '<p>Test Image</p>', '<p>Test Image</p>', '28-08-2316932172831828990828.jpg', '3', '1', '[\"2\"]', 1.00, 5000.00, '2023-08-28 08:08:04', '2023-08-28 08:08:04'),
(5, 'Test Image second', 'Test Image second', '<p>Test Image second</p>', '<p>Test Image second</p>', '28-08-231693217362767542917.jpg', '3', '1', '[\"2\"]', 1.00, 50000.00, '2023-08-28 08:09:23', '2023-08-28 08:09:23');
...
CREATE TABLE `settings` (
  ...
  `tagged` longtext DEFAULT NULL,
  `copyrigth` longtext DEFAULT NULL,
  `about_ar` longtext DEFAULT NULL,
  `about_en` longtext DEFAULT NULL,
  `policy_ar` longtext DEFAULT NULL,
  `why_us_ar` longtext DEFAULT NULL,
  `why_us_en` longtext DEFAULT NULL,
...
CREATE TABLE `social_media` (
  ...
  `social_icon` varchar(191) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
