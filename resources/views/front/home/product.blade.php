            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <form action="#" class="btn_quantity_cart_fav">
                            ...
                            <div class="btns_cart_fav">
                                <button type="button" data-id="{{$pro->id}}" class="btn-animation-2 ods"
                                        style="background-color: #EE5084; border-color: bisque;">
                        ...
                        <div class="ssk-block">
                            <a href="https://www.facebook.com/JamliaStore?mibextid=LQQJ4d" target="_blank"
                               class="ssk ssk-text ssk-facebook">
                            ...
                            <a href="https://instagram.com/jamliastore?igshid=MzRlODBiNWFlZA==" target="_blank"
                               class="ssk ssk-text ssk-google-plus">
