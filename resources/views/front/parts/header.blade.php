...
<header>
    <!-- START:: TOP HEADER -->
    {{--        <div class="top_header" style="background-color:#b91847; color:#fff;">--}}
    <div class="top_header" style="background-color:#EE5084 ; color:#fff;">
        <div class="container">
    ...
    <!-- START:: CENTER HEADER -->
    <div class="center_header" style="background-color:#fff; color:#b91847;">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="logo_site">
                    <a href="{{route('front.home')}}">
                        ...
                        <img src="{{asset('dist/front/assets/images/logo/jamlia_4.png')}}" alt="logo" height="90" width="200px">


<!-- {{--                        <img src="{{asset('dist/front/assets/images/logo/jamlia_svg.svg')}}" alt="" height="50px" width="100px">--}} -->
                    </a>
                </div>

                <div class="search_site">
                    <form action="{{route('front_nav_search',['div'=> 1])}}">
                        <div class="form-group">
                            <input type="text" name="search" class="form-control" id="searchIcon"
                                   placeholder="ابحث هنا" style="border: 1px solid #ced4da;">
                ...
                <div class="wishlist_cart">
                    <div class="wishlist_icon">
                        @if(auth()->guard('customer')->check() || auth()->guard('dealer')->check())
                            ...
                            <a style="background-color:#fff; color:#b91847;"
                                    ...
                                    <a style="background-color:#fff; color:#b91847;"
                                       href="{{ route('front.login') }}">
                                        ...
                                        <img src="{{asset('dist/front/assets/images/icons/heart.svg')}}"
                                             style="filter: invert(67%) sepia(0%) saturate(8%) hue-rotate(162deg) brightness(87%) contrast(91%) !important;" alt="" width="" height=""/>
                                        @if(auth()->guard('customer')->check() || auth()->guard('dealer')->check())
                    ...
                    <div class="cart_icon" style="background-color:#fff; color:#b91847;">

                        <a href="{{ route('front_home_cart',['div'=>$div]) }}">
                            <div>
                                <img src="{{asset('dist/front/assets/images/icons/cart.svg')}}" alt="" width="" 
                                     height="" style="filter: invert(67%) sepia(0%) saturate(8%) hue-rotate(162deg) brightness(87%) contrast(91%) !important;"/>
    ...
    <!-- START:: BOTTOM HEADER -->
    {{--    <div class="bottom_header" style="background-color:#b91847; color:#fff;">--}}
    <div class="bottom_header" style="background-color:#EE5084; color:#fff;">
        <div class="container">
            <nav class="main_menu">
                <ul>
    ...
    <!-- START:: HEADER MOBILE -->
        <div class="mobile_header" style="background-color:#880E4F; color:#fff;">
        
            <div class="logo_mobile">
                {{--            <img src="{{asset('dist/front/assets/images/logo/logo2.png')}}" width="" height="" alt="">--}}
                <img src="{{asset('dist/front/assets/images/logo/jamlia_4.png')}}" width="" height="" alt="">
            </div>
            <div class="btn_menu">
    ...
    <nav class="side_menu_mobile main_menu">
        <!-- <div class="mobile_header" style="background-color:#b91847; color:#fff;">
            <div class="logo_mobile">
                <img src="{{asset('dist/front/assets/images/logo/jamlia_4.png')}}" width="" height="" alt="">
            </div>
            <div class="btn_menu">
